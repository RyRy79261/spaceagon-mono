...
| Mirror-repo publishing | **Dropped** (owner, 2026-07-18) — then **amended** (owner, 2026-07-18): a `publish.yml` workflow flattens an app to its standalone store repo on manual dispatch (first publish) and auto-releases on `main` when the manifest version is bumped — then **amended again** (owner, 2026-07-18): auto-release on `main` removed; every publish (first or update) is a manual workflow dispatch. Sideload remains the dev path. |
